...
import tasks.task_objects.unimplemented.MeetCustomer;
import tasks.task_objects.unimplemented.TaskUpdateStock;
 ...
 * A producer of tasks.
 */
public class ContinuousTasksProducer_old implements Runnable {
...
//	private static Log log = new Logger(false);
	...
	public ContinuousTasksProducer_old(BlockingQueue<Task_OLD> taskQueue, Department saleDept, Department stockDept) {	
...
//						taskQueue.put(new MeetCustomer(salesDept)); // TODO
						break;
